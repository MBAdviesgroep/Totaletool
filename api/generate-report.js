...
function buildPrompt({ system_prompt, notities, brochureCount }) {
  ...
  return base + SCHEMA_EXTENSION +
    ...
    (notities ? '\n\nToelichting/wensen van de adviseur (zwaar laten meewegen, weegt zwaarder dan automatisch herkende tekst uit het bronrapport):\n' + String(notities).slice(0, 4000) : '');
}
