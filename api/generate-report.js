...
- MAATREGELEN: neem ALLE verduurzamingsmaatregelen over die in het bronrapport staan — laat er geen weg en kies geen subset — en VUL ZE AAN met je eigen advies-maatregelen (gemarkeerd met "eigen_advies": true). Elke maatregel (rapport én eigen advies) krijgt een eigen post (naam, capex, bes, tvt, co2) en een eigen SDG-koppeling. BELANGRIJK: zet de tekst "(eigen advies)" of iets dergelijks NOOIT in het "naam"-veld — de naam bevat alleen de maatregel zelf; markeer een eigen advies UITSLUITEND via het aparte veld "eigen_advies": true. Houd de besparing per maatregel realistisch t.o.v. de huidige energiekosten. Voeg alleen een echte LETTERLIJKE dubbeling samen (exact dezelfde maatregel twee keer vermeld); combineer verder GEEN losse maatregelen. Reken nooit tweemaal besparing op exact hetzelfde warmteverlies (bijv. als gevel- én spouwisolatie hetzelfde verlies dekken: tel de overlappende besparing één keer, maar laat beide maatregelen wel als aparte posten staan). Houd de terugverdientijd per maatregel realistisch (capex ÷ jaarlijkse besparing, doorgaans 2–25 jaar); meld een TVT > 20 jaar — of zonnepanelen met een lange TVT — expliciet als aandachtspunt in plaats van als vanzelfsprekend rendement.
